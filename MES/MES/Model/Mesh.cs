...
namespace MES
{
    class Mesh
    {
        ...
        //    GenerateNodes();
        //    GenerateElements();
        //    GenerateJacobianMatrix(); //matrixCreator
        ...
        //        for (int i = 0; i < 4; i++)
        //            for (int j = 0; j < 4; j++)
        //                Cglobal[_elements[k].IDS[i], _elements[k].IDS[j]] += _elements[k].C[i,j];
        //}
        ...
        //        for (int i = 0; i < 4; i++)
        //            Pglobal[_elements[k].IDS[i]] += _elements[k].P[i];
        ...
        //        for (int i = 0; i < 4; i++)
        //            for (int j = 0; j < 4; j++)
        //                Hglobal[_elements[k].IDS[i], _elements[k].IDS[j]] += _elements[k].H[i,j];
        //}
        ...
        //            _elements.Add(new Element(j, j + NodesInHeightDim, j + NodesInHeightDim + 1, j + 1));
        //        i += NodesInHeightDim;
        //    }
        ...
        //{
        //    foreach (Element el in this._elements)
        //        Plocal(el);
        //}
        ...
        //                    jakobian1D = (_nodes[el.IDS[3]].Y - _nodes[el.IDS[0]].Y) * 0.5;
        //                    break;
        //                case 1:
        ...
        //                    jakobian1D = (_nodes[el.IDS[1]].X - _nodes[el.IDS[0]].X) * 0.5;
        //                    break;
        //                case 2:
        //                    punktycalkowania[0, 0] = 1;
        //                    punktycalkowania[0, 1] = -0.5773;
        //                    punktycalkowania[1, 0] = 1;
        //                    punktycalkowania[1, 1] = 0.5773;
        //                    jakobian1D = (_nodes[el.IDS[2]].Y - _nodes[el.IDS[1]].Y) * 0.5;
        //                    break;
        //                case 3:
        //                    punktycalkowania[0, 0] = 0.5773;
        //                    punktycalkowania[0, 1] = 1;
        //                    punktycalkowania[1, 0] = -0.5773;
        //                    punktycalkowania[1, 1] = 1;
        //                    jakobian1D = (_nodes[el.IDS[2]].X - _nodes[el.IDS[3]].X) * 0.5;
        //                    break;
        //            }
